...
export default class Game {
    constructor(user, password) {
        ...
        this.IQ = 0;
        this.upgrades = [];
        this.class = ""; //Add class functionality later.
    }
    ...
    onTick() {
        ...
        this.lines += tickAmount * tickMultiplier * allMultiplier;
        this.IQ += (tickAmount * tickMultiplier * allMultiplier)/1000;
    }
    ...
    onClick() {
        ...
        this.lines += clickAmount * clickMultiplier * allMultiplier;
        this.IQ += clickAmount * clickMultiplier * allMultiplier;
    }
